...
public class AddCommandeServlet extends HttpServlet {
    ...
    throws ServletException {
        ...
        try {
           ...
           Long fournisseurTxt = Long.valueOf((String) request.getParameter("fournisseur")).longValue();
            
            Fournisseur fournisseur =null;
            try {
             fournisseur = (Fournisseur) em.createNamedQuery("findFournisseur",Fournisseur.class).setParameter("id", fournisseurTxt).getSingleResult();
            }
